...
export class ObjectDetection {
  ...
  private async infer(
    ...
    console.log(`expanding dims took ${t1 - t0} ms`);
    ...
    t1 = performance.now();
    console.log(`inference took ${t1 - t0} ms`);
    ...
    t1 = performance.now();
    console.log(`calculating max scores took ${t1 - t0} ms`);
    ...
    t1 = performance.now();
    console.log(`non max suppression took ${t1 - t0} ms \n\n`);
